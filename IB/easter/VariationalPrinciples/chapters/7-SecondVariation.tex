...
\begin{align*}
  F[y + \varepsilon \xi] - F[y] &= \varepsilon \int_{\alpha}^{\beta} \xi(x) \frac{\delta F[y]}{\delta y(x)} \d{x} + \varepsilon \cancelto{0}{\eval{\xi \pderiv{f}{y'}}{\alpha}{\beta}} + \varepsilon^2 \delta^2 F[y, \xi] + O(\varepsilon^3)
\end{align*}
