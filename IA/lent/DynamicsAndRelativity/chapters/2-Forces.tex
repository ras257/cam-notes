...
\section{Friction}
\begin{remark}[Note]
  In this section of the course, we will cover \textit{fluid drag} (friction due to an object moving through a fluid), however later in the course, we will study \textit{dry friction} (friction between two objects in contact with each other).
\end{remark}
