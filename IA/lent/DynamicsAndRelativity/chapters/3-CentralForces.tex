...
\begin{align*}
  ...
  \frac{(x - x_c)^2}{\frac{r^2_0}{(1 - e^2)^2}} + \frac{y^2}{\frac{r^2_0}{(1 - e^2)^3}} &= 1
\end{align*}
Where $x_c = \frac{r_0 e}{e - 1}$.
As $0 < e < 1 \implies 1 - e^2 > 0$ so we can define $a^2 = \frac{r^2_0}{(1 - e^2)^2}$ and $b^2 = \frac{r^2_0}{(1 - e^2)^3}$ so that the equation becomes:
\[
