...
We can find a frame where $P$ and $R$ (or any other event outside the light cones) ere simultaneous since the line joining them makes an angle $<\ang{45}$ and so this could be a line of simultaneity in a different frame.
