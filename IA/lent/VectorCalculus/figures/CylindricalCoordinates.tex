% From https://tex.stackexchange.com/a/614355 - Alexander Tsagkaropoulos
...
\begin{pgfonlayer}{main}
    \draw[very thick] (O) -- (A);
    \fill (A) circle (1.5pt) node[left] {$\vec{x}$};
...
\begin{pgfonlayer}{foreground}
    ...
    \tdplotdrawarc[thick]{(0,0,\zvec)}{\rvec+\drvec} {\phivec}{\phivec+\dphivec}{below}{$\rho\mathrm{d}\phi$}
\end{pgfonlayer}
