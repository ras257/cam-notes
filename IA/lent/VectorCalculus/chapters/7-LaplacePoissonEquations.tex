...
\end{example}
\begin{remark}
  Similarly to with spheres of charge in \cref{asymmetricSphers}, we can also obtain this result by using a superposition of a sphere of radius $b$ with density $\rho_0$ and a sphere of radius $a$ with density $-\rho_0$.
