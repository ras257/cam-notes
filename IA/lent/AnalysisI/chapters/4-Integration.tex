...
\begin{proof}\par
  ...
  \begin{align*}
    U(f, \mathcal{P}') - U(g, \mathcal{P}') \leq \sum_{\substack{j = 1 \\ I_j \subset J}}^{n} |I_j| \left(\sup_{x \in I_j} f(x)\right) \leq M\sum_{\substack{j = 1 \\ I_j \subset J}}^{n} |I_j| < M\varepsilon
  \end{align*}
  so:
  \begin{align*}
    \int_{a}^{b} f(x) \d{x} - \int_{a}^{b} g(x) \d{x} &\leq U(f, \mathcal{P}') - L(g, \mathcal{P}') \\
                                                      &= U(f, \mathcal{P}') - U(g, \mathcal{P}') + U(g, \mathcal{P}') - L(g, \mathcal{P}') \\
                                                      &< M\varepsilon + \varepsilon = (M + 1)\varepsilon
  \end{align*}
  and similarly $L(f, \mathcal{P}') - L(g, \mathcal{P}') \geq -M\varepsilon$ so $\abs{\int_{a}^{b} f(x) \d{x} - \int_{a}^{b} g(x) \d{x}} < (M + 1)\varepsilon\ \forall \varepsilon > 0$ so the two integrals must be equal.
\end{proof}
