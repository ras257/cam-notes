...
\begin{proof}
  ...
  For $\alpha_a$ and $\beta_b$, this is easy as dilations, rotations, and translations preserve circles and lines.
  So we just need to check it for $\gamma$.
  \begin{proofcases}
    \begin{case}{$C$ is a Euclidean Circle}
      If $C$ is a Euclidean circle, then $\gamma(C)$ then has equation:
      \begin{align*}
        \abs{\frac{1}{z} - c} &= r \\
      ...
      \begin{align*}
        ...
        &\iff \abs{z - \frac{c^{*}}{|c|^2 - r^2}}^2 = \frac{|c|^2}{(|c|^2 - r^2)^2} - \frac{1}{|c|^2 - r^2} \\
        &\iff \abs{z - \frac{c^{*}}{|c|^2 - r^2}}^2 = \frac{r^2}{(|c|^2 - r^2)^2} \\
        &\iff \abs{z - \frac{c^{*}}{|c|^2 - r^2}} = \frac{r}{\abs{|c|^2 - r^2}} \in \R^{+}
      \end{align*}
      which is a circle.
    \end{case}
    \begin{case}{$C$ is a line}
      If $C$ is a Euclidean line, then $\gamma(C)$ then has equation:
      \begin{align*}
      ...
      \end{align*}
      If $|a|^2 = |b|^2$, then the equation then becomes:
      \begin{align*}
        z(a - b) + z^{*}(a^{*} - b^{*}) &= 0 \\
      ...
      \begin{align*}
        ...
        \abs{z - \frac{a^{*} - b^{*}}{|a|^2 - |b|^2}}^2 &= \frac{|a -  b|}{\abs{|a|^2 - |b|^2}} \in \R^{+}\\
      \end{align*}
      which is a circle.
    \end{case}
  \end{proofcases}
