...
The temperature $T$ of a one-dimensional line evolves due to the diffusion of thermal energy and is governed by:
\[
...
\begin{example}
  ...
  \[
    ...
    \pderiv{T}{x} = \pderiv{\eta}{x} \deriv{\Theta}{\eta} = \frac{1}{2\sqrt{\kappa t}} \deriv{\Theta}{\eta}
  \]
  Therefore:
  \[
    \pderiv[2]{T}{x} = \frac{1}{2\sqrt{\kappa t}} \pderiv{\eta}{x} \deriv[2]{\Theta}{\eta} = \frac{1}{4\kappa t} \deriv[2]{\Theta}{\eta} \\
  \]
  ...
  This integral does \textbf{not} have a closed form solution, however, we can rewrite it in terms of the \textit{error function} that is defined by:
  \[
