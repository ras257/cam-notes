...
\begin{proof}[\cref{LNumber}]
  ...
  \]
  where the inequality is due to the rapid decay of the partial sums.
...
\begin{remark}[Remarks]
  \begin{enumerate}
    ...
    \item We will give another proof of the existence in transcendental numbers in the next chapter.
  \end{enumerate}
\end{remark}
